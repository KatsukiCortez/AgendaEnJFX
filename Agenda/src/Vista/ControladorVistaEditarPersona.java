...
public class ControladorVistaEditarPersona {
    @FXML
    ...
    public void setPersona(Persona persona) {
        ...
        txtCumpleanos.setText(DateUtil.format(persona.getCumpleanos()));
    ...
    private void handleOk(){
        ...
        persona.setCumpleanos(DateUtil.parse(txtCumpleanos.getText()));
    ...
    private boolean isInputValid(){
        ...
        if (txtCumpleanos.getText() == null || txtCumpleanos.getText().length() == 0) {
            ...
            if (!DateUtil.validDate(txtCumpleanos.getText())) {
